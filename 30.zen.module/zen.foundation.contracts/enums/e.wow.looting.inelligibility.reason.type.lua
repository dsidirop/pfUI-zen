...
local EWoWLootingInelligibilityReasonType = using "[declare:enum]" "Pavilion.Warcraft.Addons.Zen.Foundation.Contracts.Enums.EWoWLootingInelligibilityReasonType" -- aka roll-mode
