...
local Class = using "[declare] [blend]" "Pavilion.Warcraft.Addons.PfuiZen.Quicklaunch.Persistence.Services.AddonSettings.UserPreferences.QueryableService" {
    "IQueryableService", using "Pavilion.Warcraft.Addons.PfuiZen.Quicklaunch.Persistence.Contracts.Services.AddonSettings.UserPreferences.IServiceQueryable"
}
