...
local IUserPreferencesRepository = using "[declare] [interface] [blend]" "Pavilion.Warcraft.Addons.PfuiZen.Quicklaunch.Persistence.Contracts.Settings.UserPreferences.IRepository" {
