...
TG:AddTheory("StringsHelper.SubstringViaLength.GivenGreenInput.ShouldMatchExpectedResults",
        {
...
TG:AddTheory("StringsHelper.SubstringViaLength.GivenRedInput.ShouldErrorOut",
        {
