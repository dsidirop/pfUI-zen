...
-- todo   add tests for .IsInstanceOf()
...
-- todo         - they should probably be stored in .blendxinRaw and in .asBlendxinRaw
...
TG:AddFact("T005.Inheritance.NamespaceBlending.GivenStraightForwardBlending.ShouldWork",
        function()
            ...
            -- ACT
            function action()
                Foobar = using "[declare] [blend]" "T005.Inheritance.NamespaceBlending.GivenStraightForwardBlending.ShouldWork" {
                    ["Bar"] = {
                        a = 1,
                        b = 2,
                    },
            ...
            U.Should.Not.Be.Nil(FoobarInstance.blendxin)
            U.Should.Not.Be.Nil(FoobarInstance.asBlendxin)

            U.Should.Be.PlainlyEqual(FoobarInstance.a, 1)
            U.Should.Be.PlainlyEqual(FoobarInstance.b, 10) -- own has priority over the base
            U.Should.Be.PlainlyEqual(FoobarInstance.blendxin.a, 1) --base
            U.Should.Be.PlainlyEqual(FoobarInstance.blendxin.b, 2)
            U.Should.Be.PlainlyEqual(FoobarInstance.asBlendxin.Bar.a, 1) --explicit cast
            U.Should.Be.PlainlyEqual(FoobarInstance.asBlendxin.Bar.b, 2)
        end
)
