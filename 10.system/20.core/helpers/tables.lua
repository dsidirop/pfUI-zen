local _assert, _setfenv, _type, _next, _unpack, _pairs, _namespacer, _setmetatable = (function()
    ...
    return _assert, _setfenv, _type, _next, _unpack, _pairs, _namespacer, _setmetatable
end)()
