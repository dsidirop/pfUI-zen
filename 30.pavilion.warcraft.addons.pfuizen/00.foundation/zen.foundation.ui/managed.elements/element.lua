...
local KeyEventArgs  = using "Pavilion.Warcraft.Addons.PfuiZen.Foundation.UI.ManagedElements.EventArgs.KeyEventArgs"
local EKeyEventType = using "Pavilion.Warcraft.Addons.PfuiZen.Foundation.UI.ManagedElements.Enums.EKeyEventType"

local Class = using "[declare]" "Pavilion.Warcraft.Addons.PfuiZen.Foundation.UI.ManagedElements.Element" -- @formatter:on
