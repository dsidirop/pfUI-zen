...
local ManagedElement = using "Pavilion.Warcraft.Addons.PfuiZen.Foundation.UI.ManagedElements.Element"
local SWoWElementType = using "Pavilion.Warcraft.Addons.PfuiZen.Foundation.UI.ManagedElements.Strenums.SWoWElementType" 

local Class = using "[declare]" "Pavilion.Warcraft.Addons.PfuiZen.Foundation.UI.ManagedElements.Builder" -- @formatter:on
