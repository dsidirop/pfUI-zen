...
local SGreeniesGrouplootingAutomationMode = using "[declare] [enum]" "Pavilion.Warcraft.Addons.PfuiZen.Foundation.Contracts.Strenums.SGreeniesGrouplootingAutomationMode"
