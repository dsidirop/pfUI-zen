...
local SGreeniesGrouplootingAutomationActOnKeybind = using "[declare] [enum]" "Pavilion.Warcraft.Addons.PfuiZen.Foundation.Contracts.Strenums.SGreeniesGrouplootingAutomationActOnKeybind"
