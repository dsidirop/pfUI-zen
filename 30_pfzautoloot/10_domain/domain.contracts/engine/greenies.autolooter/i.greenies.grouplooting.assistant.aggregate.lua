...
local IGreeniesGrouplootingAssistantAggregate = using "[declare] [interface]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Domain.Contracts.Engine.GreeniesGrouplootingAssistant.IAggregate" --[[@formatter:on]]
