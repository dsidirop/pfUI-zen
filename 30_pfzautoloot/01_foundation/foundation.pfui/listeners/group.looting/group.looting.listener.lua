...
local PfuiRoll = using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Foundation.Pfui.Listeners.GroupLooting.RawBindings.PfuiRoll"

local PendingLootItemGamblingDetectedEventArgs = using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Pfui.Listeners.GroupLootingListener.Contracts.PendingLootItemGamblingDetectedEventArgs" --@formatter:on

local IGroupLootingListener = using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Foundation.Pfui.Contracts.Listeners.GroupLooting.IGroupLootingListener"

local Class = using "[declare] [blend]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Foundation.Pfui.Listeners.GroupLooting.GroupLootingListener" {
