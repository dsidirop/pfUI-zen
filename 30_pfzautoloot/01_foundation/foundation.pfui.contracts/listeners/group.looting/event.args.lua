...
local Class = using "[declare]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Pfui.Listeners.GroupLootingListener.Contracts.PendingLootItemGamblingDetectedEventArgs" --@formatter:on
