...
local SGreeniesGrouplootingAutomationActOnKeybind = using "[declare] [enum]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Foundation.Contracts.Strenums.SGreeniesGrouplootingAutomationActOnKeybind"
...
--
--                   Pavilion.Warcraft.Addons.PfuiZen.Foundation.UI.ManagedElements.EventArgs.KeyEventArgs:ToString()
--
