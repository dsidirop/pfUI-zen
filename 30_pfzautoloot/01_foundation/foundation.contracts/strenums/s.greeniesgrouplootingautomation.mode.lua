...
local SGreeniesGrouplootingAutomationMode = using "[declare] [enum]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Foundation.Contracts.Strenums.SGreeniesGrouplootingAutomationMode"
