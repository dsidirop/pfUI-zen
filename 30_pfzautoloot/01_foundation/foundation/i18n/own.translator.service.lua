...
local ZenOwnTranslatorService = using "[declare] [blend]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Foundation.Internationalization.OwnTranslatorService" { -- [note]   dont use this directly   use the ComboTranslationService instead
