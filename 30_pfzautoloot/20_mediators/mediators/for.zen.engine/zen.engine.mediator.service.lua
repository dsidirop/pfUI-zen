...
local ZenEngine              = using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Domain.Engine.ZenEngine"
local IZenEngine             = using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Domain.Contracts.Engine.IZenEngine"
...
local Class = using "[declare]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Mediators.ForZenEngine.ZenEngineMediatorService" -- @formatter:on
