...
local Class = using "[declare] [blend]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Persistence.Services.AddonSettings.UserPreferences.QueryableService" {
    "IQueryableService", using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Persistence.Contracts.Services.AddonSettings.UserPreferences.IServiceQueryable"
}
