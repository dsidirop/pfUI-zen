...
local Class = using "[declare] [blend]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Persistence.Services.AddonSettings.UserPreferences.UpdateableService" { -- @formatter:on
    "IUpdateableService", using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Persistence.Contracts.Services.AddonSettings.UserPreferences.IServiceUpdateable"
}
