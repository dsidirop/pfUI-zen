...
local IZenEngineMediatorService = using "[declare] [interface]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Mediators.ForZenEngine.IZenEngineMediatorService" -- @formatter:on
