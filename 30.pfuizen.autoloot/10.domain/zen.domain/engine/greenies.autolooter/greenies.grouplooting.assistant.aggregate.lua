...
local PfuiGroupLootingListener = using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Foundation.Pfui.Listeners.GroupLooting.GroupLootingListener"
...
local Class = using "[declare] [blend]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Domain.Engine.GreeniesGrouplootingAssistant.Aggregate" { --@formatter:on
    "IGreeniesGrouplootingAssistantAggregate", using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Domain.Contracts.Engine.GreeniesGrouplootingAssistant.IAggregate" 
}
