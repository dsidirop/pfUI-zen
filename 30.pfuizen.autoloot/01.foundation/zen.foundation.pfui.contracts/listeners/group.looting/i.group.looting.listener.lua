...
local IGroupLootingListener = using "[declare] [interface]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Foundation.Pfui.Contracts.Listeners.GroupLooting.IGroupLootingListener"
