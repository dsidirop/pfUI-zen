...
local RequestingCurrentUserPreferencesEventArgs                 = using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Controllers.Pfui.Contracts.Forms.Events.RequestingCurrentUserPreferencesEventArgs"
...
local IUserPreferencesForm = using "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Controllers.Pfui.Contracts.Forms.IUserPreferencesForm"

local Form = using "[declare] [blend]" "Pavilion.Warcraft.Addons.PfuiZen.Autoloot.Controllers.Pfui.Forms.UserPreferencesForm" {
