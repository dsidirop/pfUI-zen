...
function IPfuiHeaderBuilder:ChainSet_Height(height)
end

--- @param showNotHide boolean the visibility of the control, true to show, false to hide
function IPfuiHeaderBuilder:ChainSet_Visibility(showNotHide)
end

--- @return frame frame the native pfUI control frame that is built by this builder
function IPfuiHeaderBuilder:Show()
end

--- @return frame frame the native pfUI control frame that is built by this builder
function IPfuiHeaderBuilder:Hide()
end
