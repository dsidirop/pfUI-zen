...
local EWoWLootingInelligibilityReasonType = using "[declare:enum]" "Pavilion.Warcraft.Addons.Zen.Externals.WoW.Enums.EWoWLootingInelligibilityReasonType" -- aka roll-mode
